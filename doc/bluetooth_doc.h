 ...
 * @brief Bluetooth PBAP(Phonebook Access Profile) API provides functions for managing connections to phonebook server and getting phonebook data.
 * @ingroup CAPI_NETWORK_BLUETOOTH_MODULE
 *
 ...
 * The @a Server is a device that has a phonebook data. The @a Client is a device that requests the phonebook data from the @a Server.
