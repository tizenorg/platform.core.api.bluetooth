...
%if "%{?profile}" == "wearable"
export CFLAGS="$CFLAGS -DTELEPHONY_DISABLED -DTIZEN_HDP_DISABLE -DTIZEN_HID_HOST_DISABLE -DTIZEN_OPP_CLIENT_DISABLE -DTIZEN_OPP_SERVER_DISABLE"
export CXXFLAGS="$CXXFLAGS -DTELEPHONY_DISABLED -DTIZEN_HDP_DISABLE -DTIZEN_HID_HOST_DISABLE -DTIZEN_OPP_CLIENT_DISABLE -DTIZEN_OPP_SERVER_DISABLE"
export FFLAGS="$FFLAGS -DTELEPHONY_DISABLED -DTIZEN_HDP_DISABLE -DTIZEN_HID_HOST_DISABLE -DTIZEN_OPP_CLIENT_DISABLE -DTIZEN_OPP_SERVER_DISABLE"
%endif
