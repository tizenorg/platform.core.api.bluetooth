...
%if "%{?profile}" == "common"
export CFLAGS="$CFLAGS -DTIZEN_HFP_DISABLE -DTELEPHONY_DISABLED"
export CXXFLAGS="$CXXFLAGS -DTIZEN_HFP_DISABLE -DTELEPHONY_DISABLED"
export FFLAGS="$FFLAGS -DTIZEN_HFP_DISABLE -DTELEPHONY_DISABLED"
%endif
