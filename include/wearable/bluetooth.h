 ...
 *
 * @param[in] remote_address The device address of remote device.
 * @return 0 on success, otherwise a negative error value.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_INVALID_PARAMETER  Invalid parameter
 ...
 *
 * @param[in] remote_address The device address of remote device.
 * @param[in] mouse_data The mouse data that need to be passed to remote device
 * @return 0 on success, otherwise a negative error value.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_INVALID_PARAMETER  Invalid parameter
 ...
 *
 * @param[in] remote_address The device address of remote device.
 * @param[in] key_data The key data the need to be passed to remote device
 * @return 0 on success, otherwise a negative error value.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_INVALID_PARAMETER  Invalid parameter
 ...
 * @param[in] user_data The user data from application which will be provided in callback.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_INVALID_PARAMETER  Invalid parameter
 *
 ...
 *
 * @param[in] remote_address The device address of remote device.
 * @param[in] htype The Header type to be there in response
 * @param[in] ptype The Parameter type to be there in response.
 * @param[in] data The data to be present in data payload of response.
