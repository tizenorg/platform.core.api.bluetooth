...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_PBAP_CLIENT_MODULE
 * @brief Disconnects from PBAP server
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/bluetooth
 *
...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_PBAP_CLIENT_MODULE
 * @brief Gets size of phonebook from PBAP server
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/bluetooth
 *
 ...
 * @param[in] callback The callback function called when PBAP Phonebook Size is Returned.
...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_PBAP_CLIENT_MODULE
 * @brief Gets contacts/call logs as vCards from PBAP server
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/bluetooth
 *
 ...
 * @param[in] callback The callback function called when PBAP Phonebook is Pulled.
...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_PBAP_CLIENT_MODULE
 * @brief Gets Contact or Call List from PBAP server
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/bluetooth
 *
...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_PBAP_CLIENT_MODULE
 * @brief Gets a contact/call log from PBAP server
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/bluetooth
 *
