...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_PBAP_CLIENT_MODULE
 * @brief Sets the destination path of file to be pulled.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/bluetooth
 * @param[in] destination  The destination path of file to be pulled
 * @return 0 on success, otherwise a negative error value.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_NOT_ENABLED  Not enabled
 ...
 * @retval #BT_ERROR_NOT_SUPPORTED   Not supported
 */
int bt_pbap_set_destination(const char *destination);
