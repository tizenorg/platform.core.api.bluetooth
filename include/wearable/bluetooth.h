 ...
 *              which can be obtained with bt_pbap_get_list() or bt_pbap_search_phone_book().
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/bluetooth
 *                 http://tizen.org/privilege/mediastorage
 ...
 * @pre The PBAP client must be initialized with bt_pbap_init().
 * @pre PBAP connection must be created with bt_pbap_connect().
 * @pre The vCard information (#bt_pbap_vcard_info_s) must be obtained with bt_pbap_get_list() or bt_pbap_search_phone_book().
 * @see bt_pbap_connect()
 * @see bt_pbap_get_list()
 * @see bt_pbap_search_phone_book()
 */
