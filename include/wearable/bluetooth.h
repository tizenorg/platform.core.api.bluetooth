 ...
 * @brief Registers the method for the HID Device role.
 * @since_tizen 3.0
 * @privlevel pubilc
 * @privilege %http://tizen.org/privilege/bluetooth
 *
 * @remarks This function must be called to register HID UUID.
 * This function must be called to register the HID UUID. Only then a remote device is able to identify this one as a HID device.
 *
...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_HID_DEVICE_MODULE
 * @brief Unregisters the method for the HID Device role.
 * @since_tizen 3.0
 * @privlevel pubilc
 * @privilege %http://tizen.org/privilege/bluetooth
 *
...
/**
 * @ingroup CAPI_NETWORK_BLUETOOTH_HID_DEVICE_MODULE
 * @brief Disconnects from the HID Host device.
 * @since_tizen 3.0
 * @privlevel pubilc
 * @privilege %http://tizen.org/privilege/bluetooth
 *
 ...
 *
 * @param[in] remote_address The remote device's address.
 * @param[in] mouse_data The mouse data to be passed to remote device.
 * @return 0 on success, otherwise a negative error value.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_INVALID_PARAMETER  Invalid parameter
 ...
 * @brief The key data to be passed to remote device
 * @since_tizen 3.0
 * @privlevel pubilc
 * @privilege %http://tizen.org/privilege/bluetooth
 *
 * @param[in] remote_address The remote device's address.
 * @param[in] key_data The key data to be passed to remote device
 * @return 0 on success, otherwise a negative error value.
 * @retval #BT_ERROR_NONE  Successful
 * @retval #BT_ERROR_NOT_INITIALIZED  Not initialized
 * @retval #BT_ERROR_INVALID_PARAMETER  Invalid parameter
 ...
 *
 * @param[in] remote_address The remote device's address.
 * @param[in] htype The response header type
 * @param[in] ptype The response parameter type
