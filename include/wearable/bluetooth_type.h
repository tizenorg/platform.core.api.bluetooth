 ...
 */
typedef struct {
	unsigned char btcode; /**< The bt code value */
	unsigned char rep_id; /**< The ID value */
	unsigned char button; /**< The button value */
	signed char axis_x; /**< The value of x's location */
	signed char axis_y; /**< The value of y's location */
	signed char axis_z; /**< The value of z's location */
} bt_hid_mouse_data_s;
...
typedef struct {
	unsigned char btcode; /**< The bt code value */
	unsigned char rep_id; /**< The ID value */
	unsigned char modify; /**< The modify value */
	unsigned char key[8]; /**< The key value */
} bt_hid_key_data_s;
 ...
 */
typedef enum {
	BT_HID_HEADER_HANDSHAKE, /**< Bluetooth HID hearder type Handshake */
	BT_HID_HEADER_HID_CONTROL, /**< Bluetooth HID hearder type HID control */
	BT_HID_HEADER_GET_REPORT, /**< Bluetooth HID hearder type Get report */
	BT_HID_HEADER_SET_REPORT, /**< Bluetooth HID hearder type Set report */
	BT_HID_HEADER_GET_PROTOCOL, /**< Bluetooth HID hearder type Get protocol */
	BT_HID_HEADER_SET_PROTOCOL, /**< Bluetooth HID hearder type Set protocol */
	BT_HID_HEADER_DATA, /**< Bluetooth HID hearder type Data */
	BT_HID_HEADER_UNKNOWN /**< Bluetooth HID hearder type unknown */
 ...
 */
typedef struct {
	const char *address;  /**< The address of HID device's role */
	bluetooth_hid_header_type_t type;  /**< Header type */
	bluetooth_hid_param_type_t param;  /**< Parameter type */
	int data_size;  /**< The length of the received data */
