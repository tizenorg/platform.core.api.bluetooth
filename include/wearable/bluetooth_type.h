 ...
 * @since_tizen 3.0
 *
 * @param[in] result The result of connecting or disconnecting to the remote device
 ...
 */
typedef void (*bt_pbap_connected_cb)(int result, const char *remote_address,
 ...
 * @see bt_pbap_disconnect()
 */
typedef void (*bt_pbap_phone_book_get_cb)(int result, const char *remote_address,
...
typedef void (*bt_pbap_list_vcards_cb)(int result, const char *remote_address,
		const char **vcards, int count, void *user_data);
