 ...
 * @param[in] vcf_file vcard file name include the absolute path in which vCards are saved (@a vcf_file is valid only in the callback. If you want to use it outside the callback, please make a copy. @a vcf_file should not be freed.)
