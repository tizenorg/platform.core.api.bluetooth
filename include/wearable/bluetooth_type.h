 ...
 */
typedef enum {
	BT_HID_MOUSE_BUTTON_LEFT = 0x00, /**<The mouse's left key value*/
	BT_HID_MOUSE_BUTTON_RIGHT,  /**<The mouse's left right value*/
	BT_HID_MOUSE_BUTTON_MIDDLE  /**<The mouse's middle key value*/
 ...
 */
typedef struct {
	bt_hid_mouse_button_e button; /**< The button value, 0 ~ 2 */
 ...
 * @since_tizen 3.0
 * @details If you want to know more that, refer to http://www.usb.org/developers/hidpage/ and see "HID Usage Tables"
 *
