...
typedef struct {
	...
	signed char axis_x; /**< The location's x value */
	signed char axis_y; /**< The location's y value */
	signed char padding; /**< The padding value */
} bt_hid_mouse_data_s;
 ...
 */
typedef struct {
	unsigned char modify; /**< The modifier keys : such as shift, alt */
...
typedef struct {
	...
	bt_hid_header_type_t type;  /**< The header type */
	bt_hid_param_type_t param;  /**< The parameter type */
	int data_size;  /**< The length of the received data */
