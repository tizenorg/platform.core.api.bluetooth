...
} bluetooth_gatt_att_request_type_t;
 ...
 * @param[in] gatt_handle The characteristic and descriptor's GATT handle which has an old value
 ...
 * @param[in] request_id The identification of this request. It will be used to send a response.
 * @param[in] server The GATT server handle
 * @param[in] gatt_handle The characteristic and descriptor's GATT handle to be read
