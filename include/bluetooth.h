...
typedef enum
{
	...
	BT_ERROR_NOT_SUPPORTED = TIZEN_ERROR_NETWORK_CLASS, /**< Not Supported */
	BT_ERROR_PERMISSION_DENIED = TIZEN_ERROR_NETWORK_CLASS, /**< Permission denied */
	BT_ERROR_QUOTA_EXCEEDED = TIZEN_ERROR_NETWORK_CLASS, /**< Quota exceeded */
