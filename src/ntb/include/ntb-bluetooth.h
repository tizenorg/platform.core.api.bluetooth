...
#endif
int ntb_bt_adapter_get_local_oob_data(unsigned char **hash, unsigned char **randomizer,
					int *hash_len, int *randomizer_len);
int ntb_bt_adapter_set_remote_oob_data(const char *remote_address,
				unsigned char *hash, unsigned char *randomizer,
				int hash_len, int randomizer_len);
int ntb_bt_adapter_remove_remote_oob_data(const char *remote_address);
/*
...
int ntb_bt_device_is_profile_connected(const char *remote_address, bt_profile_e bt_profile,
...
int ntb_bt_nap_disconnect_all(void);
int ntb_bt_nap_disconnect(const char *remote_address);
