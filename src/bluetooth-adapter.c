...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_get_local_info(chipset, firmware,
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_set_visibility(visibility_mode,
							timeout_sec);
	return error_code;
#else
	bluetooth_discoverable_mode_t discoverable_mode = BLUETOOTH_DISCOVERABLE_MODE_CONNECTABLE;
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_set_connectable_changed_cb(callback,
								user_data);
	return error_code;
#else
	return BT_ERROR_NOT_SUPPORTED;
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_foreach_bonded_device(foreach_cb,
								user_data);
	return error_code;
#else
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_get_bonded_device_info(remote_address,
								device_info);
	return error_code;
#else
	int ret;
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_set_visibility_mode_changed_cb(
						callback, user_data);
	return error_code;
#else
	int ret = BT_ERROR_NONE;
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_set_device_discovery_state_changed_cb(
							callback, user_data);
	return error_code;
#else
	int ret = BT_ERROR_NONE;
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_set_visibility_duration_changed_cb(
							callback, user_data);
	return error_code;
#else
	return BT_ERROR_NOT_SUPPORTED;
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_get_local_oob_data(hash, randomizer,
...
#ifdef NTB
	int error_code = BT_ERROR_NONE;
	error_code = ntb_bt_adapter_set_remote_oob_data(remote_address, hash,
					randomizer, hash_len, randomizer_len);
	return error_code;
#else
	return BT_ERROR_NOT_SUPPORTED;
#endif
